...
namespace AdeptusMechanicus
{
 //   [StaticConstructorOnStartup]
    public class ShoulderPadEntry : IExposable
    {
        ...
        private const float SubInterval = 0f;
        private const float YOffset_Utility_South = 0f;
        private const float YOffset_Shell = 88f;
        private const float YOffset_Head = 0f;
        private const float YOffset_Utility = 0f;
        private const float YOffset_OnHead = 0f;
        private const float YOffset_PostHead = 0f;
        private const float YOffset_CarriedThing = 0f;
        private const float YOffset_PrimaryEquipmentUnder = 0f;
        private const float YOffset_CarriedThingUnder = 0f;
        private const float YOffset_Behind = 0f;
        private const float YOffset_Body = 0f;
        private const float YOffsetInterval_Clothes = 0f;
        private const float YOffset_PrimaryEquipmentOver = 0f;
        private const float YOffset_Status = 0f;
        ...
        public void UpdateGraphic()
        {
            ...
            Graphic graphic = GraphicDatabase.Get<Graphic_Multi>(path, shader, size, color, colorTwo);
