    ...
    //    public static bool enabled_XenobiologisDarkEldar;
        ...
        public static Faction OfChaosMarine
        {
            get
            {
                ...
                return Find.FactionManager.FirstFactionOfDef(DefDatabase<FactionDef>.GetNamed("QX_ChaosMarineFaction"));
            }
        }
        public static Faction OfTraitorGuard
        {
            get
            {
                ...
                return Find.FactionManager.FirstFactionOfDef(DefDatabase<FactionDef>.GetNamed("QX_TraitorGuardFaction"));
            }
        }
        public static Faction OfTyranid
        {
            get
            {
                ...
                return Find.FactionManager.FirstFactionOfDef(DefDatabase<FactionDef>.GetNamed("QX_TyranidFaction"));
            }
        }
    }
}