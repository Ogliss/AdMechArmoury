        ...
        public static void ArmouryModOptionsMenu(Listing_StandardExpanding listing_Main)
        {
            ...
            // Armoury mod Allowed Weapons options menu
            {
                ...
                if (listing.CheckboxLabeled("AdeptusMechanicus.ShowAllowedWeapons".Translate(), ref settings.ShowAllowedWeapons, "AdeptusMechanicus.ShowAllowedWeaponsDesc".Translate(), false, false, ArmouryMain.collapseTex, ArmouryMain.expandTex, extend: true))
                {
                    ...
                    {
                        listing_General.CheckboxLabeled("AdeptusMechanicus.AllowAssassinorumWeapons".Translate(), ref settings.allowAssassinorumWeapons, "AdeptusMechanicus.AllowAssassinorumWeaponsDesc".Translate(), !settings.AllowImperialWeapons, extend: true);
                        listing_General.CheckboxLabeled("AdeptusMechanicus.AllowAstartesWeapons".Translate(), ref settings.allowAstartesWeapons, "AdeptusMechanicus.AllowAstartesWeaponsDesc".Translate(), !settings.AllowImperialWeapons, extend: true);
                        listing_General.CheckboxLabeled("AdeptusMechanicus.AllowInquisitorialWeapons".Translate(), ref settings.allowInquisitorialWeapons, "AdeptusMechanicus.AllowInquisitorialWeaponsDesc".Translate(), !settings.AllowImperialWeapons, extend: true);
                        listing_General.CheckboxLabeled("AdeptusMechanicus.AllowMechanicusWeapons".Translate(), ref settings.allowMechanicusWeapons, "AdeptusMechanicus.AllowMechanicusWeaponsDesc".Translate(), !settings.AllowImperialWeapons, extend: true);
                        listing_General.CheckboxLabeled("AdeptusMechanicus.AllowMilitarumWeapons".Translate(), ref settings.allowMilitarumWeapons, "AdeptusMechanicus.AllowMilitarumWeaponsDesc".Translate(), !settings.AllowImperialWeapons, extend: true);
                        listing_General.CheckboxLabeled("AdeptusMechanicus.AllowSororitasWeapons".Translate(), ref settings.allowSororitasWeapons, "AdeptusMechanicus.AllowSororitasWeaponsDesc".Translate(), !settings.AllowImperialWeapons, extend: true);
                    }
                    ...
                    listing.EndSection(listing_General);
                    length_AWRulesContent = listing_General.MaxColumnHeightSeen;
                }
                listing_Menu.EndSection(listing);
