...
namespace AdeptusMechanicus.ExtensionMethods
{
    ...
    public static class VerbExtensions
    {
        ...
        public static bool MultiShot(this Verb verb, out int Extras, out float Spread, out float PerCell)
        {
            Extras = 0;
            Spread = 0f;
            PerCell = 0f;
            ...
            if (result)
            {
                ...
                Spread = verb.SpecialRules().ScattershotSpread;
                PerCell = verb.SpecialRules().ScattershotSpreadPerCell;
            }
            return result;
        }
