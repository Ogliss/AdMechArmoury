        ...
        */
        ...
        public static bool isPsyker(this Pawn pawn, out int Level, out float Mult)
        {
            ...
            if (pawn.RaceProps.Humanlike)
            {
                ...
                if (pawn.story.traits.HasTrait(AdeptusTraitDefOf.PsychicSensitivity))
                {
                    result = pawn.story.traits.DegreeOfTrait(AdeptusTraitDefOf.PsychicSensitivity) > 0;
                    Level = pawn.story.traits.DegreeOfTrait(AdeptusTraitDefOf.PsychicSensitivity);
                }
                else
                {
