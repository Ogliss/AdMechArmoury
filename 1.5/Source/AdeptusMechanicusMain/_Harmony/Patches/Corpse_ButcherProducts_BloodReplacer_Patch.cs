...
namespace AdeptusMechanicus.HarmonyInstance
{
    ...
    {// change to transpiler
        ...
        private static IEnumerable<Thing> ButcherProducts(Corpse __instance, Pawn butcher, float efficiency)
        {
            ...
            {
                butcher.needs.mood.thoughts.memories.TryGainMemory(AdeptusThoughtDefOf.ButcheredHumanlikeCorpse, null);
                foreach (Pawn pawn in butcher.Map.mapPawns.SpawnedPawnsInFaction(butcher.Faction))
                {
                    ...
                    {
                        pawn.needs.mood.thoughts.memories.TryGainMemory(AdeptusThoughtDefOf.KnowButcheredHumanlikeCorpse, null);
                    }
                }
