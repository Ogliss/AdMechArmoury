...
//    [HarmonyPatch(typeof(Verse.PawnRenderUtility), "DrawEquipmentAiming", new Type[] { typeof(Thing), typeof(Vector3), typeof(float) }), StaticConstructorOnStartup]
    public static class PawnRenderUtility_DrawEquipmentAiming_GunDrawing_Patch
    {
        [HarmonyPrefix, HarmonyPriority(Priority.First)]
        static void Prefix(ref Thing eq, ref Vector3 drawLoc, ref float aimAngle)
        {
            Pawn ___pawn = eq.holdingOwner.Owner as Pawn;
