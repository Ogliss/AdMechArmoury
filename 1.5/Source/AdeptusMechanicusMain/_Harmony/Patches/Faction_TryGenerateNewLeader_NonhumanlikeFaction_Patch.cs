...
namespace AdeptusMechanicus.HarmonyInstance
{
	...
	public static class Faction_Notify_PawnJoined_NonhumanlikeFaction_Patch
    {
		// generate leader for non-humanlike Factions
		[HarmonyPrefix]
		public static bool Prefix(Faction __instance, Pawn p)
		{
            if (__instance.def.defName.StartsWith("OG_") && !__instance.def.humanlikeFaction && p.RaceProps.Humanlike)
            {
                if (__instance.ideos != null)
                {
	...
	public static class Faction_TryGenerateNewLeader_NonhumanlikeFaction_Patch
	{
		...
		public static bool tryGenNewLeader(Faction faction)
        {
			...
			{
				PawnGenerationRequest request = new PawnGenerationRequest(kind, faction, PawnGenerationContext.NonPlayer, -1, faction.def.leaderForceGenerateNewPawn, false, false, true, false, 1f, false, true, true, true, false, false, false, false, false, 0f, 0f, null, 1f, null, null, null, null, null, null, null, null, null, null, null, null, false, false, false);
