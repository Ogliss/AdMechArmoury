...
namespace AdeptusMechanicus.HarmonyInstance
{
    ...
    public static class Verb_EquipmentLaunchProjectile_TryCastShot_WeaponSpecialRules_Patch
    {
        [HarmonyPrefix]
        ...
        public static bool TryCastExtraShot(ref AbilitesExtended.Verb_EquipmentLaunchProjectile __instance, LocalTargetInfo currentTarget, bool canHitNonTargetPawnsNow)
        {
            ...
            if (f1)
            {
                shootLine.ChangeDestToMissWild_NewTemp(shotReport.AimOnTargetChance_StandardTarget, projectile.projectile.flyOverhead, __instance.caster.Map);
