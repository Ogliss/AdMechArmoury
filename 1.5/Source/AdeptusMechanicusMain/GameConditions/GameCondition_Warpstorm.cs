...
namespace AdeptusMechanicus
{
	...
	public class GameCondition_Warpstorm : GameCondition
	{
		...
		{
			List<Pawn> allPawnsSpawned = map.mapPawns.AllPawnsSpawned as List<Pawn>;
        ...
        public static void DriveInsane(Pawn p)
        {
            ...
            p.mindState.mentalStateHandler.TryStartMentalState(MentalStateDefOf.Berserk, null, true, false, false, null, false, false, false);
        }
