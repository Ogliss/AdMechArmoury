...
namespace AdeptusMechanicus.Lasers
{
    ...
    public class LaserBeamGraphic : Thing
    {
        ...
        protected virtual void Explode()
        {
            ...
            float aP = this.projectile?.ArmorPenetration ?? this.projDef.projectile.GetArmorPenetration(1f, null);
            ...
            GenExplosion.DoExplosion(center, map2, explosionRadius, damageDef, launcher, damageAmount, aP, soundExplode, equipmentDef, def, null, postExplosionSpawnThingDef, postExplosionSpawnChance, postExplosionSpawnThingCount, this.projDef.projectile.postExplosionGasType, this.projDef.projectile.applyDamageToExplosionCellsNeighbors, preExplosionSpawnThingDef, this.projDef.projectile.preExplosionSpawnChance, this.projDef.projectile.preExplosionSpawnThingCount, this.projDef.projectile.explosionChanceToStartFire, this.projDef.projectile.explosionDamageFalloff);
        }
