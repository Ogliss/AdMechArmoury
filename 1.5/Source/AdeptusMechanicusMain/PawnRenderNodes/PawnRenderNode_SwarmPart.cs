        ...
        public override Graphic GraphicFor(Pawn pawn)
        {
            ...
            switch (pawn.Drawer.renderer.CurRotDrawMode)
            {
                case RotDrawMode.Fresh:
                    ...
                    {
                        return graphic.GetColoredVersion(ShaderDatabase.Cutout, MutantUtility.GetSkinColor(pawn, new Color?(graphic.Color)).Value, MutantUtility.GetSkinColor(pawn, new Color?(graphic.ColorTwo)).Value);
                    }
                    return graphic;
