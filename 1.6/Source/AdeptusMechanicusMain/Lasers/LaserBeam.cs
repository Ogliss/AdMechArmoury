...
namespace AdeptusMechanicus.Lasers
{
    public class LaserBeam : Bullet
    {
        ...
        public override void DrawAt(Vector3 drawLoc, bool flip = false) { /*if (AMAMod.Dev) Log.Message(this.Label);*/ }
        ...
        public void SpawnBeam(Vector3 a, Vector3 b, Thing hitThing = null)
        {
            ...
            Beamgraphic.Setup(launcher, a, b, verb, hitThing, effecter, def.explosionEffect, this);
        ...
        public virtual void Explode(Thing hitThing, bool destroy = false)
        {
            ...
            GenExplosion.DoExplosion(center, map2, explosionRadius, damageDef, launcher, damageAmount, 0f, soundExplode, equipmentDef, def, null, postExplosionSpawnThingDef, postExplosionSpawnChance, postExplosionSpawnThingCount, null, null, 255, this.def.projectile.applyDamageToExplosionCellsNeighbors, preExplosionSpawnThingDef, this.def.projectile.preExplosionSpawnChance, this.def.projectile.preExplosionSpawnThingCount, this.def.projectile.explosionChanceToStartFire, this.def.projectile.explosionDamageFalloff);
        }
