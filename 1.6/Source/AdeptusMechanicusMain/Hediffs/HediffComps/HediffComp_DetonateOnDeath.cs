...
namespace AdeptusMechanicus
{
	...
	public class HediffComp_DetonateOnDeath : HediffComp
	{
		...
		protected void Detonate(Map map, bool ignoreUnspawned = false, bool kill = true)
		{
			...
			GenExplosion.DoExplosion(this.parent.pawn.PositionHeld, map, num, dmg, parent, props.damageAmountBase > 0 ? props.damageAmountBase : dmg.defaultDamage, props.armorPenetrationBase, props.explosionSound ?? dmg.soundExplosion, null, null, null, props.postExplosionSpawnThingDef, props.postExplosionSpawnChance, props.postExplosionSpawnThingCount, null, null, 255, props.applyDamageToExplosionCellsNeighbors, props.preExplosionSpawnThingDef, props.preExplosionSpawnChance, props.preExplosionSpawnThingCount, props.chanceToStartFire, props.damageFalloff, null, null);
		}
