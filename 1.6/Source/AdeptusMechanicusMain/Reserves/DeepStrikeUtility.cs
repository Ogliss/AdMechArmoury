...
namespace AdeptusMechanicus
{
    ...
    public static class DeepStrikeUtility
    {
        ...
        public static void MakeDropPodAt(IntVec3 c, Map map, ActiveTransporterInfo info, FactionDefExtension extension = null)
        {
            ...
            ActiveTransporter activeDropPod = (ActiveTransporter)ThingMaker.MakeThing(ActiveDropPod, null);
            activeDropPod.Contents = info;
            SkyfallerMaker.SpawnSkyfaller(DropPodIncoming, activeDropPod, c, map);
        }

        public static void MakeFlyerLandAt(IntVec3 c, Map map, ActiveTransporterInfo info, FactionDefExtension extension = null)
        {
        ...
        public static void MakeTunnelAt(IntVec3 c, Map map, ActiveTransporterInfo info, FactionDefExtension extension = null)
        {
        ...
        public static void MakeTeleportAt(IntVec3 c, Map map, ActiveTransporterInfo info, FactionDefExtension extension = null)
        {
            /*
