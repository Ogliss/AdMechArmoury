...
namespace AdeptusMechanicus
{
    ...
    public class TeleportSpawner : ThingWithComps, IThingHolder
    {
        ...
        public override void Tick()
        {
            ...
            if (Rand.MTBEventOccurs(TeleportSpawner.FilthSpawnMTB, 1f, 1.TicksToSeconds()) && CellFinder.TryFindRandomReachableCellNearPosition(base.Position, base.Position, base.Map, TeleportSpawner.FilthSpawnRadius, TraverseParms.For(TraverseMode.NoPassClosedDoors, Danger.Deadly, false), null, null, out IntVec3 c, 999999))
            {
            ...
            if (Ext != null)
            {
                ...
                {
                    GenExplosion.DoExplosion(position, map, Ext.blastradius, Ext.damageDef, null, -1, -1f, null, null, null, null, null, 0f, 1, null, null, 255, false, null, 0f, 1, 0f, false);
                }
            }
