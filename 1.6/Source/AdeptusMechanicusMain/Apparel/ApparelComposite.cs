...
namespace AdeptusMechanicus
{
    ...
    public class ApparelComposite : Apparel
    {
        ...
        */
        ...
        private bool? onhead;
        public bool OnHead => (onhead != null ? onhead.Value : (onhead = this.def.apparel.LastLayer == ApparelLayerDefOf.Overhead || this.RenderAsPack() || this.def.apparel.wornGraphicPath == BaseContent.PlaceholderImagePath).Value);
