    ...
    public class Comp_Shield : CompShield
    {
        ...
        public override void PostPreApplyDamage(ref DamageInfo dinfo, out bool absorbed)
        {
            ...
            if (Props != null)
            {
                ...
                if ((dinfo.Def.externalViolenceForMechanoids || dinfo.Def == DamageDefOf.EMP) && Props.brokenByEMP)
                {
                    this.energy = 0f;
                    this.Break();
                    return;
        ...
        public new virtual void Draw()
        {
            if (this.ShieldState == ShieldState.Active && this.ShouldDisplay)
            {
                ...
                float angle = 0f;
                Vector3 s = new Vector3(num * (PawnOwner.Drawer.renderer.BodyGraphic.drawSize.x * Props.drawX), 1f, num * (PawnOwner.Drawer.renderer.BodyGraphic.drawSize.y * Props.drawY));
