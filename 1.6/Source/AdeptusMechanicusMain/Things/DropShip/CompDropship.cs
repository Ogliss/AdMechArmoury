    ...
    public class CompDropship : CompTransporter
    {
        ...
        private void StartChoosingDestination(bool localOnly = false)
        {
            if (localOnly)
            {
                ...
                Find.Targeter.BeginTargeting(TargetingParameters.ForDropPodsDestination(), delegate (LocalTargetInfo x)
                {
                    this.TryLaunch(mapparent.Tile, new TransportersArrivalAction_LandInSpecificCell(mapparent, x.Cell), null);
                }, null, delegate
                {
            ...
            */
            ...
            if (cafr == null)
            {
             ...
             //   Building fuelingPortSource = this.FuelingPortSource;//compTransporter.Launchable.FuelingPortSource;
                ...
                ActiveTransporter activeDropPod = (ActiveTransporter)ThingMaker.MakeThing(ThingDef.Named(this.parent.def.defName + "_Active"), null);
            ...
            //    CompUSCMDropship dropship1 = null;
                ...
                */
                ...
                TravellingTransporters travelingTransportPods = (TravellingTransporters)WorldObjectMaker.MakeWorldObject(DefDatabase<WorldObjectDef>.GetNamed(this.parent.def.defName + "_Traveling", true));
        ...
        private void CheckAutoload()
        {
            ...
            if (CompDropship.tmpRequiredItems.Any<ThingDefCount>() || CompDropship.tmpRequiredPawns.Any<Pawn>())
            {
                ...
                CompDropship.tmpAllSendableItems.AddRange(TransporterUtility.AllSendablePawns(this.TransportersInGroup, this.parent.Map));
