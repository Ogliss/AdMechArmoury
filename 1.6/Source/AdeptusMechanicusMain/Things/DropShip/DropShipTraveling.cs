...
namespace AdeptusMechanicus
{
	...
	public class DropShipTraveling : TravellingTransporters
	{
			...
			get
			{
				...
				else
				{
					...
					if (flag2)
					{
						...
						GraphicRequest graphicRequest = new GraphicRequest(this.flyingThing.def.graphicData.graphicClass, this.flyingThing.def.graphicData.texPath, ShaderTypeDefOf.Cutout.Shader, this.flyingThing.def.graphic.drawSize, Color.white, Color.white, this.flyingThing.def.graphicData, 0, null, null);
					...
					result = ((ExpandableWorldObjectsUtility.TransitionPct(this) > 0f) ? this.flyingThing.Graphic.MatNorth : this.material);
				}
				return result;
			}
		}
