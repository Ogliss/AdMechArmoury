...
namespace AdeptusMechanicus
{
    ...
    public class DropShipLeaving : FlyShipLeaving, IActiveTransporter, IThingHolder
    {
		public new ActiveTransporterInfo Contents
		{
			get
			{
				return ((ActiveTransporter)this.innerContainer[0]).Contents;
			}
			set
			{
				((ActiveTransporter)this.innerContainer[0]).Contents = value;
			}
		}
        ...
        public override void LeaveMap()
        {
            ...
            travelingTransportPods.flyingThing = DropShipLeaving.tmpActiveTransporters.Find(delegate (Thing x)
            {
