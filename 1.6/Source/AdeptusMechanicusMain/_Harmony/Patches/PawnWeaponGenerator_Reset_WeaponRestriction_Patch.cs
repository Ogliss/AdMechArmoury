...
namespace AdeptusMechanicus.HarmonyInstance
{
    ...
    public static class PawnWeaponGenerator_Reset_WeaponRestriction_Patch
    {
        ...
        public static void Postfix(ref List<ThingStuffPair> ___allWeaponPairs)
        {
            ...
            {
                ___allWeaponPairs.RemoveAll(x => 
                (x.thing.defName.StartsWith("OGI_") || x.thing.defName.StartsWith("OGOA_") || x.thing.defName.StartsWith("OGAA_") || x.thing.defName.StartsWith("OGIQ_") || x.thing.defName.StartsWith("OGAM_") || x.thing.defName.StartsWith("OGIG_") || x.thing.defName.StartsWith("OGAS_")) 
                && (x.thing.defName.Contains("_Gun_") || x.thing.defName.Contains("_Melee_")));
            }
            else
            {
                if (!AMAMod.settings.AllowAssassinorumWeapons)
                {
                    ___allWeaponPairs.RemoveAll(x => (x.thing.defName.StartsWith("OGOA_")) && (x.thing.defName.Contains("_Gun_") || x.thing.defName.Contains("_Melee_")));
                }
                if (!AMAMod.settings.AllowAstartesWeapons)
                {
                    ___allWeaponPairs.RemoveAll(x => (x.thing.defName.StartsWith("OGAA_")) && (x.thing.defName.Contains("_Gun_") || x.thing.defName.Contains("_Melee_")));
                }
                if (!AMAMod.settings.AllowInquisitorialWeapons)
                {
                    ___allWeaponPairs.RemoveAll(x => (x.thing.defName.StartsWith("OGIQ_")) && (x.thing.defName.Contains("_Gun_") || x.thing.defName.Contains("_Melee_")));
                }
                if (!AMAMod.settings.AllowMechanicusWeapons)
                {
                    ___allWeaponPairs.RemoveAll(x => (x.thing.defName.StartsWith("OGAM_")) && (x.thing.defName.Contains("_Gun_") || x.thing.defName.Contains("_Melee_")));
                }
                if (!AMAMod.settings.AllowMilitarumWeapons)
                {
                    ___allWeaponPairs.RemoveAll(x => (x.thing.defName.StartsWith("OGIG_")) && (x.thing.defName.Contains("_Gun_") || x.thing.defName.Contains("_Melee_")));
                }
                if (!AMAMod.settings.AllowSororitasWeapons)
                {
                    ___allWeaponPairs.RemoveAll(x => (x.thing.defName.StartsWith("OGAS_")) && (x.thing.defName.Contains("_Gun_") || x.thing.defName.Contains("_Melee_")));
                }
            }
