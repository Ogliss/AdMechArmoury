    ...
    public class WarpLostPawnsTracker : WorldComponent
    {
        ...
        public void Kidnap(Pawn pawn, Pawn kidnapper)
        {
            ...
            if (pawn.Faction == Faction.OfPlayer)
            {
                ...
                if (kidnapper != null)
                {
                    Find.LetterStack.ReceiveLetter("LetterLabelPawnsKidnapped".Translate(pawn.Named("PAWN")), "LetterPawnsKidnapped".Translate(pawn.Named("PAWN"), kidnapper.Faction.Named("FACTION")), LetterDefOf.NegativeEvent, null, 0);
                }
            }
