...
namespace AdeptusMechanicus
{
    ...
    public static class PawnRenderUtility
    {
        ...
        {
            Material baseMat = pawn.IsPsychologicallyInvisible() ? InvisibilityMatPool.GetInvisibleMat(original) : original;
        ...
        public static Mesh GetPawnMesh(bool portrait, Pawn pawn, Rot4 facing, bool wantsBody)
        {
            ...
            if (!wantsBody)
            {
                return pawn.Drawer.renderer.HeadGraphic.MeshAt(facing);
            }
            return pawn.Drawer.renderer.BodyGraphic.MeshAt(facing);
        }
