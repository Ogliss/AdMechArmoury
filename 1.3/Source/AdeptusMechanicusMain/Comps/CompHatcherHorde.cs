    ...
    public class CompHatcherHorde : ThingComp
    {
		...
		public void Hatch()
		{
			try
			{
				...
				PawnGenerationRequest request = new PawnGenerationRequest(spawnKind, this.hatcheeFaction, PawnGenerationContext.NonPlayer, -1, false, true, false, false, true, false, 1f, false, true, true, true, false, false, false, false, 0f, 0f, null, 1f, null, null, null, null, null, null, null, null, null, null, null, null);
