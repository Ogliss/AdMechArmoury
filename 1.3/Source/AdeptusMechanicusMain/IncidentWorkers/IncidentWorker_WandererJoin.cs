...
namespace AdeptusMechanicus
{
    ...
    public class IncidentWorker_WandererJoin : IncidentWorker
    {
        ...
        public override bool TryExecuteWorker(IncidentParms parms)
        {
            ...
            PawnGenerationRequest request = new PawnGenerationRequest(pawnKind, ofPlayer, PawnGenerationContext.NonPlayer, -1, true, false, false, false, true, this.def.pawnMustBeCapableOfViolence, 20f, false, true, true, true, false, false, false, false, 0f, 0f, null, 1f, null, null, null, null, null, null, null, fixedGender, null, null, null, null);
