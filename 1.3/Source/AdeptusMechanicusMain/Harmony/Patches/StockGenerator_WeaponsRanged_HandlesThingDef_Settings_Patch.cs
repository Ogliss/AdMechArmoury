...
namespace AdeptusMechanicus.HarmonyInstance
{
    ...
    {
        [HarmonyPostfix]
        public static void Postfix(StockGenerator_WeaponsRanged __instance, ThingDef td, ref bool __result) 
        {
            if (__result && td.defName.StartsWith("OG") && td.defName.Contains("_Gun_"))
            {
                if (__instance.weaponTag.NullOrEmpty())
                {
                    __result = false;
                    return;
                }
                if (td.defName.StartsWith("OGI_Gun_"))
                {
                ...
                if (td.defName.StartsWith("OGAM_Gun_"))
                {
                ...
                if (td.defName.StartsWith("OGE_Gun_"))
                {
                ...
                if (td.defName.StartsWith("OGDE_Gun_"))
                {
                ...
                if (td.defName.StartsWith("OGC_Gun_"))
                {
                ...
                if (td.defName.StartsWith("OGT_Gun_"))
                {
                ...
                if (td.defName.StartsWith("OGO_Gun_"))
                {
                ...
                if (td.defName.StartsWith("OGN_Gun_"))
                {
                ...
                if (td.defName.StartsWith("OGTY_Gun_"))
                {
