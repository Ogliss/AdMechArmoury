...
{
    public static class ApparelRestrictionUtility
    {
        public static bool CanWear(Thing thing, Pawn pawn, ref string cantReason, bool __result)
        {
    ...
    public static class EquipmentUtility_CanEquip_Restricted_Patch
    {
        ...
        public static void Postfix(Thing thing, Pawn pawn, ref string cantReason, ref bool __result)
        {
            if (__result)
            {
                ...
                {
                    __result = ApparelRestrictionUtility.CanWear(thing, pawn, ref cantReason, __result);
                }
