...
namespace AdeptusMechanicus
{
    public class Apparel_VisibleAccessory : Apparel
    {
        ...
        public override void DrawWornExtras()
        {
            ...
            if (this.onHead)
            {
                Log.ErrorOnce(string.Concat("AdeptuysMechanicus :: Apparel_VisibleAccessoryNC: The head drawing code is incomplete and the apparel '",
        ...
        protected bool onHead
        {
            get
            {
                if (!_OnHeadCache.ContainsKey(def.defName))
                {
                    ...
                    if (!_OnHeadCache.ContainsKey(def.defName))
                    {
                        Log.ErrorOnce(string.Concat("AdeptuysMechanicus :: ", this.GetType(), " was unable to determine if body or head on item '", Label,
