...
namespace AdeptusMechanicus.AirStrikes
{
	...
	public abstract class FlyingSpaceship : Thing
	{
		...
		public override void SpawnSetup(Map map, bool respawningAfterLoad)
		{
			...
			{
				FlyingSpaceshipAirStrike airStrike = this as FlyingSpaceshipAirStrike;
				if (airStrike != null)
				{
		...
		public void ConfigureShipTexture(SpaceshipKind spaceshipKind, AirStrikeDef strikeDef = null)
		{
			switch (spaceshipKind)
			{
				...
				case SpaceshipKind.Airstrike:
					this.spaceshipTexture = FlyingSpaceship.strikeshipTexture;
					this.spaceshipShadowTexture = FlyingSpaceship.strikeshipShadowTexture;
					this.baseSpaceshipScale = FlyingSpaceship.supplySpaceshipScale;
					break;
				default:
					Log.ErrorOnce("MiningCo. Spaceship: unhandled SpaceshipKind (" + this.spaceshipKind.ToString() + ").", 123456784, false);
					break;
			}
            if (strikeDef != null && spaceshipKind == SpaceshipKind.Airstrike)
            {
        ...
        public override void ExposeData()
		{
			...
			Scribe_Values.Look<SpaceshipKind>(ref this.spaceshipKind, "spaceshipKind", SpaceshipKind.CargoPeriodic, false);
		...
		public SpaceshipKind spaceshipKind = SpaceshipKind.Airstrike;
		...
		public static Material strikeshipShadowTexture = MaterialPool.MatFrom("Things/StrikeShip/StrikeShip_Shadow");
