...
namespace AdeptusMechanicus.HarmonyInstance
{
    ...
    public static class AM_MainTabWindow_Research_DrawResearchPrereqs_AnyOneOf_Patch
    {
        [HarmonyPrefix]
        public static bool Prefix(MainTabWindow_Research __instance, ResearchProjectDef project, Rect rect, ref float __result)
		{
			...
			{
				AnyPrerequisiteResearchExtension ext = project.GetModExtension<AnyPrerequisiteResearchExtension>();
