...
namespace AdeptusMechanicus.HarmonyInstance
{
    ...
    public static class AM_PawnBioAndNameGenerator_FillBackstorySlotShuffled_Test_Patch
    {
        [HarmonyPrefix]
        ...
        public static List<BackstoryCategoryFilter> GetBackstoryCategoryFiltersFor(Pawn pawn, FactionDef faction)
        {
            ...
            {
                AM_PawnBioAndNameGenerator_FillBackstorySlotShuffled_Test_Patch.FallbackCategoryGroup
            };
        }
        ...
        {
            return AM_PawnBioAndNameGenerator_FillBackstorySlotShuffled_Test_Patch.SelectionWeightFactorFromWorkTagsDisabled(bs.workDisables);
        }

        // Token: 0x06001504 RID: 5380 RVA: 0x000A3BA2 File Offset: 0x000A1FA2
        public static float BioSelectionWeight(PawnBio bio)
        {
            return AM_PawnBioAndNameGenerator_FillBackstorySlotShuffled_Test_Patch.SelectionWeightFactorFromWorkTagsDisabled(bio.adulthood.workDisables | bio.childhood.workDisables);
        }
