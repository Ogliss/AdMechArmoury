    ...
    public class StatPart_Reliability : StatPart
    {
        public override void TransformValue(StatRequest req, ref float val)
        {
            if (req.HasThing && req.Thing.TryGetCompFast<CompWeapon_GunSpecialRules>() != null)
            {
                ...
                parentStat.formatString = reliabilityString;
                switch (reliabilityString)
                {
                    case "Unreliable":
                        parentStat.description = "This gun is unreliable in combat and can fail easily.";
                        break;
                    case "Standard":
                        parentStat.description = "This gun is reliable in combat but can occationally fail.";
                        break;
                    case "Very Reliable":
                        parentStat.description = "This gun is very reliable in combat and tends not to fail.";
                        break;
                    case "Extremely Reliable":
                        parentStat.description = "This gun is extremely reliable in combat and tends not to fail.";
                        break;
                    default:
                        return;
                }
