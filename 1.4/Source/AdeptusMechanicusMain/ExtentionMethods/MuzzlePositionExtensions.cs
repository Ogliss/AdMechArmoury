...
namespace AdeptusMechanicus.ExtensionMethods
{
    public static class MuzzlePositionExtensions
    {
        ...
        public static bool Muzzle(this Verb verb, out float barrelLength, out float barrelOffset, out float bulletOffset, out FleckDef flareDef, out float flareSize, out FleckDef smokeDef, out float smokeSize)
        {
            bool result = false;
            IMuzzlePosition m;
            barrelLength = 0;
