    ...
    public class Projectile_Laser : Projectile
    {
        ...
        */
        ...
        protected void DetermineImpactExactPosition()
        {
            ...
            DistancetoTarget = numberOfSegments;
        ...
        protected override void Impact(Thing hitThing)
        {
            ...
            if (hitThing != null)
            {
                ...
                int damageAmountBase = this.DamageAmount;
                float armorPenetration = base.ArmorPenetration;
                bool isMelta = Def.IsMelta;
                Map map = base.Map;
                float targetDistanceFromShooter = DistancetoTarget;
                float MaxRange = launcherPawn.equipment.PrimaryEq.PrimaryVerb.verbProps.range;
                BattleLogEntry_RangedImpact battleLogEntry_RangedImpact = new BattleLogEntry_RangedImpact(this.launcher, hitThing, this.intendedTarget.Thing, this.equipmentDef, this.def, this.targetCoverDef);
                Find.BattleLog.Add(battleLogEntry_RangedImpact);
                if (hitThing != null)
                {
                    float MeltaRange = MaxRange / 2; 
                    bool isinMetlaRange = targetDistanceFromShooter <= MeltaRange;
                    if (isinMetlaRange && isMelta == true)
                    {
                        damageAmountBase = this.DamageAmount*2;
                        armorPenetration = base.ArmorPenetration*2;
                    }
                ...
                else
                {
                    ...
                    {
                        MoteMaker.MakeWaterSplash(this.ExactPosition, map, Mathf.Sqrt((float)this.DamageAmount) * 1f, 4f);
                    }
                }
