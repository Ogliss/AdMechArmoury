...
{
    public class ThingDef_BulletEffectCE : AmmoDef
    {
    ...
    public class Projectile_BulletEffectCE : BulletCE
    {
        #region Properties
        public ThingDef_BulletEffectCE Def
        {
            get
            {
                return this.def as ThingDef_BulletEffectCE;
            }
        }
