...
*/
    ...
    public static class Projectile_Impact_DistortWeapon_Patch_CE
    {
        public static void Impact_DistortWeapon_Postfix(ref ProjectileCE __instance, ref Thing ___launcher, ref LocalTargetInfo ___intendedTarget, Thing hitThing)
        {
            if (hitThing !=null)
            {
                if (hitThing.def.thingClass == typeof(Pawn))
