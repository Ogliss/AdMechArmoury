...
{
    [HarmonyPatch(typeof(Verb_MeleeAttackCE), "DamageInfosToApply")]
    public static class Verb_MeleeAttackDamage_DamageInfosToApply_SpecialWeapon_Patch_CE
    {
        public static IEnumerable<DamageInfo> Postfix(IEnumerable<DamageInfo> __result, Verb_MeleeAttackCE __instance, LocalTargetInfo target)
        {
        ...
        public static DamageInfo GetPowerDamage(DamageInfo cloneSource, Verb_MeleeAttackCE __instance, LocalTargetInfo target)
        {
            float AP = 2;
        ...
        public static DamageInfo GetWitchbladeDamage(DamageInfo cloneSource, Verb_MeleeAttackCE __instance, LocalTargetInfo target)
        {
        ...
        public static DamageInfo GetForceDamage(DamageInfo cloneSource, Verb_MeleeAttackCE __instance, LocalTargetInfo target)
        {
