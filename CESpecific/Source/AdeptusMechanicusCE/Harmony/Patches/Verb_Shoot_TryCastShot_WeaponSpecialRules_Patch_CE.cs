...
namespace AdeptusMechanicus.HarmonyInstance
{
    ...
    //    public static FieldInfo currentTarget = typeof(CombatExtended.Verb_ShootCE).GetField("currentTarget", BindingFlags.Instance | BindingFlags.NonPublic | BindingFlags.GetField);
        public static FieldInfo canHitNonTargetPawnsNow = typeof(CombatExtended.Verb_ShootCE).GetField("canHitNonTargetPawnsNow", BindingFlags.Instance | BindingFlags.NonPublic | BindingFlags.GetField);
        // Token: 0x0600651E RID: 25886 RVA: 0x001B8BC0 File Offset: 0x001B6FC0
        public static bool TryCastExtraShot(ref CombatExtended.Verb_ShootCE __instance, LocalTargetInfo currentTarget, bool canHitNonTargetPawnsNow)
        {
