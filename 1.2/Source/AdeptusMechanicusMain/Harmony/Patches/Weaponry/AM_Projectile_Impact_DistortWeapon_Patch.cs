...
namespace AdeptusMechanicus.HarmonyInstance
{
    ...
    public static class AM_Projectile_Impact_Patch
    {
        [HarmonyPrefix]
...
public static class AM_Projectile_Impact_Necron_Wraith_Patch
{
    [HarmonyPrefix]
...
*/
    ...
    [HarmonyPatch(typeof(Projectile), "Impact")]
    public static class AM_Projectile_Impact_DistortWeapon_Patch
    {
        [HarmonyPostfix]
